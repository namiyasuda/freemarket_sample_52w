class DeliveryMethod < ActiveHash::Base
  ...
  # id= 10~13は着払い・購入者負担
  self.data = [
    {id: 1, name: '未定', payside_id: 1}, {id: 2, name: 'らくらくメルカリ便', payside_id: 1}, {id: 3, name: 'ゆうメール', payside_id: 1}, {id: 4, name: 'レターパック', payside_id: 1}, {id: 5, name: '普通郵便(定形、定形外)', payside_id: 1}, {id: 6, name: 'クロネコヤzマト', payside_id: 1},
